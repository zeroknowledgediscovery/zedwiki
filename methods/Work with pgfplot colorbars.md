...
Because we usually generate plot with python `matplotlib` but use LaTex for colorbar, I post here the python code I used to generate the RGB 3-tuples at the beginning:
```
import pylab as plt
