...
<<Warn("None of this holds up to actual experiments:  Chris Bale's paper shows that  more mixing may lead to more polarization, in explicit social media experiments (not graph simulations).")>>
